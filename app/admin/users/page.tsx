...
function Page() {
    return (
        <>
            <div className="flex w-full flex-row align-items-center bg-gray-700">
                <Adminnav/>
                <div className="bg-gray min-h-screen text-white flex flex-col items-center pt-28 gap-8 w-full">
                    <div className="text-center">
                        <h2 className="text-48px">Welcome Back <span className="text-green">Dear</span></h2>
                        <p className="text-18px">Enjoy the fullest </p>
                    </div>
