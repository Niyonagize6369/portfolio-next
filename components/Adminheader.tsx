...
function Adminheader() {
  ...
  return (
    <div
      className={`font-poppins h-screen space-y-8 pl-6 pr-8 py-8 bg-gray-700 text-white font-bold transition-all duration-200 ${
    ...
    >
      ...
      <button
        ...
        className="absolute bottom-4 p-2 bg-gray-400 rounded-full hover:bg-guidebg-dark transition-colors text-whiteText"
      >
        {isExpanded ? (
